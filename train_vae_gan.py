...
from utils import Discriminator, gan_loss_fake, gan_loss_real, gan_loss_d, gan_loss_g
...
def main():
    ...
    def preprocess_train(examples):
        images = [np.expand_dims(np.load(image)[:,:624], 0) for image in examples[image_column]]
