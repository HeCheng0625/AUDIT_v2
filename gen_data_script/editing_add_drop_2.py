...
json_lists = []
remove_json_lists = []
add_wav_path = "/blob/v-yuancwang/AUDITDATA/add_2/wav"
add_mel_path = "/blob/v-yuancwang/AUDITDATA/add_2/mel"
...
for i in tqdm(range(50000)[:]):
    ...
    template = np.random.choice(a_add_b_2_templates)
    ...
    pre_pad_length = np.random.randint(16000*4, 16000*5)
...
with open("/home/v-yuancwang/AUDIT_v2/editing_medata_infos/add_2.json", "w") as f:
    json.dump(json_lists, f)
with open("/home/v-yuancwang/AUDIT_v2/editing_medata_infos/drop_2.json", "w") as f:
